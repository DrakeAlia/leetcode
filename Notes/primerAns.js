...
function addFavoriteBook(bookName) {
    ...
    // `someString.includes(anotherString)` will return `true` if `anotherString` is found 
    // inside `someString`, or `false` otherwise.
...
function printFavoriteBooks() {
    ...
    // 5. Finally, `printFavoriteBooks()` should loop through the `favoriteBooks` array 
